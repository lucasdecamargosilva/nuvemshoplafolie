(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=lafolie';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ===============================================
    const apiKey = "pl_live_4e68047faf83b9e628fcad73bae29051f7d2785b4ba5336d2f90f75f946ed4a4";
    ...
    const WEBHOOK_PIX = 'https://n8n.segredosdodrop.com/webhook/lafolie-pix';
    const WEBHOOK_PIX_STATUS = 'https://n8n.segredosdodrop.com/webhook/lafolie-pix-status';
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/lafolie-check-limit';
    ...
    const styles = `
        ...
        .q-btn-trigger-ia {
            position: absolute; top: 92px; right: 14px; z-index: 100;
        ...
        /* Mobile: selo no TOPO da foto do produto (no desktop segue em top:92px) */
        @media (max-width: 767px) { .q-btn-trigger-ia { top: 10px; } }
    ...
    const html = `
        <div id="q-modal-ia">
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=lafolie" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=lafolie" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'lafolie', origin: location.origin })
                    });
                    pix = await resp.json();
...
const fd = new FormData();
                    ...
                    console.log('[PL La Folie] Enviando', allProdImgs.length, 'fotos do produto');
